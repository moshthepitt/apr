    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.CharField(max_length=255, verbose_name='File Number', blank=True)),
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(unique=True, max_length=255, verbose_name='Phone Number', blank=True)),
