...
from apr.views import HomeView, DashboardView, CustomerRedirect, DayView
from apr.views import PricingView
from apr.views import SupportView, generate_pdf_view, PDFView, ErrorView
from apr.views import ThreeDayView
from appointments.views import AppointmentClientConfirm
...
urlpatterns = [
    ...
    url(r'^help/$', SupportView.as_view(template_name="core/help.html"),
        name='help'),
    ...
    # client actions
    url(r'^confirm/(?P<slug>[\w-]+)/$', AppointmentClientConfirm.as_view(),
        name='confirm_appointment'),
    url(r'^cancel/(?P<slug>[\w-]+)/$', AppointmentClientCancel.as_view(),
        name='cancel_appointment'),

    # utils
    url(r'^customer-redirector/$', CustomerRedirect.as_view(),
