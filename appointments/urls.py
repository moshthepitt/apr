...
from appointments.ajax import event_feed, process_add_user_form, process_select_user_form, process_add_event_form
...
urlpatterns = patterns('',
    ...
    url(r'^add-event-form/', process_add_event_form, name='process_add_event_form'),
    #regular
